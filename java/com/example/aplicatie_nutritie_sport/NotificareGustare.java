...
public class NotificareGustare  extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        PendingIntent pendingIntent = stackBuilder.getPendingIntent(100, PendingIntent.FLAG_UPDATE_CURRENT);//getting the pendingIntent
        ...
        Notification notification = builder.setContentTitle("Aplicatie de nutritie si sport")
                .setContentText("Este timpul pentru o gustare sanatoasa!")
