...
public class NotificarePranz extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        PendingIntent pendingIntent = stackBuilder.getPendingIntent(200, PendingIntent.FLAG_UPDATE_CURRENT);//getting the pendingIntent
        ...
        Notification notification = builder.setContentTitle("Aplicatie de nutritie si sport")
                .setContentText("Este timpul pentru masa de pranz!")
